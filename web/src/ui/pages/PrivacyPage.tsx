...
const PRIVACY = {
  vi: {
    ...
    s5t: '5. Liên hệ với chúng tôi',
    s5p: 'Nếu bạn có bất kỳ câu hỏi, thắc mắc hoặc phản hồi nào về Chính sách bảo mật của ThreadScore, vui lòng liên hệ:',
    studio: 'Studio:',
    website: 'Website:',
    email: 'Email:',
  },
  en: {
    ...
    s5t: '5. Contact Information',
    s5p: 'If you have any questions or concerns regarding our Privacy Policy, please reach out to:',
    studio: 'Studio:',
    website: 'Website:',
    email: 'Email:',
  },
    ...
    <div className="page privacy-page">
      <div className="container">
        ...
        <div className="privacy-content">
          ...
          <Reveal delay={0.25}>
            <section className="privacy-card">
              <h2><EnvelopeSimple size={20} color="var(--accent)" /> {m.s5t}</h2>
              <p>{m.s5p}</p>
