...
export const translations = {
  vi: {
    ...
    'sidebar.scoredComments': 'Bình luận đã chấm',
    'sidebar.commentBreakdown': 'Phân bố cảm xúc',
    'sidebar.sentimentRatio': 'Tỷ lệ cảm xúc cộng đồng',
    ...
    // SearchBox
    'sb.placeholder': 'Tìm kiếm hoặc dán link Threads...',
    'sb.search': 'Tìm',
    ...
    'tp.showing': 'Đang hiển thị {current} / {total} bình luận',
    'tp.loadMore': 'Tải thêm bình luận',
    'tp.loadingMore': 'Đang tải thêm bình luận...',
    ...
    'tp.authorFollowUp': 'Chủ thớt viết tiếp',
    'tp.replyTo': 'Trả lời @{user}',
    'tp.authorBadge': 'Tác giả',
  ...
  en: {
    ...
    'sidebar.scoredComments': 'Scored comments',
    'sidebar.commentBreakdown': 'Comment sentiment',
    'sidebar.sentimentRatio': 'Community sentiment ratio',
    ...
    // SearchBox
    'sb.placeholder': 'Search or paste a Threads link...',
    'sb.search': 'Search',
    ...
    'tp.showing': 'Showing {current} of {total} comments',
    'tp.loadMore': 'Load more comments',
    'tp.loadingMore': 'Loading more comments...',
    ...
    'tp.authorFollowUp': 'Author continued',
    'tp.replyTo': 'Replying to @{user}',
    'tp.authorBadge': 'Author',
